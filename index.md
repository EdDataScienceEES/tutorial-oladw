...
Take a moment to think about how you would customise the tooltips in this figure. If you were to write code to customise the tooltips, what would you include? If you want, explore using the `text` parameter in the first section of code to define what appears and `hoverinfo = 'text'` to display it.
